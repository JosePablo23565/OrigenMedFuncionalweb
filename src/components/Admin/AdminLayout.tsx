...
const GestionarCitasIcon = ({ size = 19 }: { size?: number }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 48 48"
        ...
        <div className={styles.sidebarHeader}>
          <div className={styles.brandRow}>
            <div className={styles.brand}>
              <img src={fullLogo} alt="Origen Med" className={styles.brandLogo} />
            </div>
          </div>
        ...
        <div className={styles.sidebarFooter}>
          <div className={styles.adminProfile}>
            ...
            <div className={styles.adminInfo}>
              <span className={styles.adminName}>{user?.email || 'Administrador'}</span>
              <span className={styles.adminRole}>Personal Médico</span>
            </div>
          </div>
